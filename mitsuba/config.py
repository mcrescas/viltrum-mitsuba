...
CXX            = 'g++-9'
CC             = 'gcc-9'
CXXFLAGS       = ['-std=c++14' ,'-O3', '-Wall', '-g', '-pipe', '-march=native', '-msse2', '-ftree-vectorize', '-mfpmath=sse', '-funsafe-math-optimizations', '-fno-rounding-math', '-fno-signaling-nans', '-fno-math-errno', '-fomit-frame-pointer', '-DMTS_DEBUG', '-DDOUBLE_PRECISION', '-DSPECTRUM_SAMPLES=3', '-fopenmp', '-fvisibility=hidden', '-mtls-dialect=gnu2', '-fPIC']
LINKFLAGS      = []
...
CPP_DEFINES    = ['OPENVDB_ABI_VERSION_NUMBER=7']
