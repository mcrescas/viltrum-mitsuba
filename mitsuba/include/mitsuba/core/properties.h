...
public:
    ...
    /// Set custom animated Value
    void setAnimatedValue(const std::string &name, const AnimatedValue *value, bool warnDuplicates = true);
    /// Get an animated linear transformation
    ref<const AnimatedValue> getAnimatedValue(const std::string &name) const;
    /// Get an animated linear transformation (with default)
    ref<const AnimatedValue> getAnimatedValue(const std::string &name, const AnimatedValue *defVal) const;
    /// Get an animated linear transformation (with default)
    ref<const AnimatedValue> getAnimatedValue(const std::string &name, const Float &defVal) const;
    ref<const AnimatedValue> getAnimatedValue(const std::string &name, const Spectrum &defVal) const;
