...
public:
    ThinLens(const Properties &props)
        ...
        m_focusDistance_animated = new AnimatedValue(props.getAnimatedValue("focusDistance", getFarClip()));
    ...
    Spectrum sampleRay(Ray &ray, const Point2 &pixelSample,
        ...
        Point focusP = nearP * (m_focusDistance_animated->eval(ray.time) / nearP.z);
    ...
    Spectrum sampleRayDifferential(RayDifferential &ray, const Point2 &pixelSample,
        ...
        /* Sampled position on the focal plane */
        Float fDist = m_focusDistance_animated->eval(ray.time) / nearP.z;
    ...
    bool getSamplePosition(const PositionSamplingRecord &pRec,
        ...
        Point intersection = localP + localD * (m_focusDistance_animated->eval(pRec.time) / localD.z);
...
private:
    ...
    ref<AnimatedValue> m_focusDistance_animated;
};
